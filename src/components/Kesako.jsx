  ...
  render() { 
    return (
      <Container>
        ...
        <Row>
          <p align='justify'>
          Fondéen avril 2017, l'association Jeune et Rose est un projet né de la rencontre de 2 jeunes femmes Christelle Rakotoarimanana et Mélanie Courtier dans les couloirs de l’hôpital alors qu'elles étaient en pleine lutte contre un cancer du sein.
          ...
          <br/>
          <a href="/teleteton/Support">Merci pour votre soutien!</a>
